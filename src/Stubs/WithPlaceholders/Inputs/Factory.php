...
namespace Cruddy\Stubs\WithPlaceholders\Inputs;

use Cruddy\Factory as BaseFactory;
use Cruddy\Exceptions\UnknownStubEditorType;
use Cruddy\Stubs\Stub;
use Cruddy\Stubs\WithPlaceholders\Files\WithInputs\Factory as WithColumnsFactory;
use Cruddy\Stubs\WithPlaceholders\Files\WithoutInputs\Factory as WithForeignKeysFactory;
