...
class StubTraitTest extends TestCase
{
    ...
    // /**
    //  * A test to remove the placeholders from a stub.
    //  *
    //  * @return void
    //  */
    // public function test_remove_placeholders()
    // {
    //     $stub = 'stub';
    //     $mock = $this->partialMock(self::class, function (MockInterface $mock) use ($stub) {
    //         $mock->shouldAllowMockingProtectedMethods();
    //         $mock->shouldReceive('replaceInStub')
    //             ->with($this->vueDataPlaceholders, '', $stub)
    //             ->once();
    //         $mock->shouldReceive('replaceInStub')
    //             ->with($this->vuePostDataPlaceholders, '', $stub)
    //             ->once();
    //         $mock->shouldReceive('replaceInStub')
    //             ->with($this->vueComponentPlaceholders, '', $stub)
    //             ->once();
    //         $mock->shouldReceive('replaceInStub')
    //             ->with($this->vuePropsPlaceholders, '', $stub)
    //             ->once();
    //         $mock->shouldReceive('replaceInStub')
    //             ->with($this->componentNamePlaceholders, '', $stub)
    //             ->once();
    //         $mock->shouldReceive('replaceInStub')
    //             ->with($this->actionPlaceholders, '', $stub)
    //             ->once();
    //         $mock->shouldReceive('replaceInStub')
    //             ->with($this->editUrlPlaceholders, '', $stub)
    //             ->once();
    //         $mock->shouldReceive('replaceInStub')
    //             ->with($this->cancelUrlPlaceholders, '', $stub)
    //             ->once();
    //         $mock->shouldReceive('replaceInStub')
    //             ->with($this->modelPlaceholders, '', $stub)
    //             ->once();
    //         $mock->shouldReceive('replaceInStub')
    //             ->with($this->modelRelationshipPlaceholders, '', $stub)
    //             ->once();
    //         $mock->shouldReceive('replaceInStub')
    //             ->with($this->modelVariablePlaceholders, '', $stub)
    //             ->once();
    //         $mock->shouldReceive('replaceInStub')
    //             ->with($this->fullModelClassPlaceholders, '', $stub)
    //             ->once();
    //         $mock->shouldReceive('replaceInStub')
    //             ->with($this->modelNamePlaceholders, '', $stub)
    //             ->once();
    //         $mock->shouldReceive('replaceInStub')
    //             ->with($this->valuePlaceholders, '', $stub)
    //             ->once();
    //         $mock->shouldReceive('replaceInStub')
    //             ->with($this->variableCollectionPlaceholders, '', $stub)
    //             ->once();
    //         $mock->shouldReceive('replaceInStub')
    //             ->with($this->variablePlaceholders, '', $stub)
    //             ->once();
    //         $mock->shouldReceive('replaceInStub')
    //             ->with($this->resourcePlaceholders, '', $stub)
    //             ->once();
    //         $mock->shouldReceive('replaceInStub')
    //             ->with($this->useStatementPlaceholders, '', $stub)
    //             ->once();
    //     });
        
    //     $result = $mock->removePlaceholders($stub);
